...
import * as T from '../../store/reducers/cart'
...
const Checkout = () => {
  ...
  const fecharPagamento = () => dispatch(T.closePayment())
  const fecharPedido = () => dispatch(T.closeOrder())
  const abrirPagamento = () => dispatch(T.openPayment())
  const limparPedido = () => dispatch(T.clear())
